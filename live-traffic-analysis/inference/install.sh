...
pip install coloredlogs flatbuffers numpy packaging protobuf sympy ffmpeg-python opencv-python-headless torch_tps psycopg2-binary redis supervision inference python-dotenv scikit-learn pyarrow ultralytics pillow
